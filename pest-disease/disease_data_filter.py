                ...
                for item in items:
                    ...
                    if item.get("cropName", "").lower() == cleaned_crop.lower():
                        result_item = {
                            ...
                            "sickNameKor": item.get("sickNameKor"),
                            "sickNameEng": item.get("sickNameEng"),
                            "cropCode": item.get("cropCode"),
                            "oriImg": item.get("oriImg"),
                            "virusKey": item.get("virusKey"),
                            "요청작물명": cleaned_crop,
                            "원본작물명": original_crop
                        }
...
if all_results:
    ...
    result_df.to_excel("/Users/kimdoyeon/Desktop/nym-data/result_disease.xlsx", index=False)
